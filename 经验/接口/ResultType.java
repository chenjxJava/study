...
public enum ResultType {
  ...
  SYSTEM_ERROR_UNKNOWN_REASON(10031, "未知异常,请联系管理员"),
  ...
  ERROR_NO_UPLOAD_FILE(10028, "至少上传一个文件"),
  ...
  ERROR_REQUEST_NOT_FIND(404, "您访问的地址不存在或已删除"),
  ERROR_REQUEST_METHOD_NOT_ALLOWED(405, "调用失败,请求方法不正确"),
